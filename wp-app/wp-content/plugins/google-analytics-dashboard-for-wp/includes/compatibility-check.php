	...
	class ExactMetrics_Compatibility_Check {
		...
		public function maybe_deactivate_plugin( $plugin ) {
			...
			if ( ! empty( $compatible_php_version['required'] ) && ! $this->is_php_compatible() ) {
				...
				wp_die(
					sprintf( esc_html__( 'Sorry, but your version of PHP does not meet ExactMetrics\' required version of %1$s%2$s%3$s to run properly. The plugin has not been activated. %4$sClick here to return to the Dashboard%5$s.', 'google-analytics-dashboard-for-wp' ),
						'<strong>',
			...
			if ( ! empty( $compatible_wp_version['required'] ) && ! $this->is_wp_compatible() ) {
				...
				wp_die(
					sprintf(
						esc_html__( 'Sorry, but your version of WordPress does not meet ExactMetrics\' required version of %1$s%2$s%3$s to run properly. The plugin has not been activated. %4$sClick here to return to the Dashboard%5$s.', 'google-analytics-dashboard-for-wp' ),
						'<strong>',
		...
		public function display_php_notice() {
			...
			<div class="error">
				<p>
					<?php echo sprintf(
						esc_html__( 'Sorry, but your version of PHP does not meet ExactMetrics\' required version of %1$s%2$s%3$s to run properly. The plugin has not been activated. %4$sClick here to return to the Dashboard%5$s.', 'google-analytics-dashboard-for-wp' ),
						'<strong>',
						$compatible_php_version['required'],
						'</strong>',
						'<a href="' . $url . '">',
